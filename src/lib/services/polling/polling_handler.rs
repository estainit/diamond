...
pub fn autoCreatePollingForProposal(params: &mut JSonObject, block: &Block) -> bool
{
    ...
    let values: HashMap<&str, &(dyn ToSql + Sync)> = HashMap::from([
        ...
        ("pll_y_count", &ZERO as &(dyn ToSql + Sync)),
        ("pll_y_shares", &ZERO as &(dyn ToSql + Sync)),
        ("pll_y_gain", &ZERO as &(dyn ToSql + Sync)),
        ("pll_y_value", &ZERO as &(dyn ToSql + Sync)),
        ("pll_n_count", &ZERO as &(dyn ToSql + Sync)),
        ("pll_n_shares", &ZERO as &(dyn ToSql + Sync)),
        ("pll_n_gain", &ZERO as &(dyn ToSql + Sync)),
        ("pll_n_value", &ZERO as &(dyn ToSql + Sync)),
        ("pll_a_count", &ZERO as &(dyn ToSql + Sync)),
        ("pll_a_shares", &ZERO as &(dyn ToSql + Sync)),
        ("pll_a_gain", &ZERO as &(dyn ToSql + Sync)),
        ("pll_a_value", &ZERO as &(dyn ToSql + Sync)),
